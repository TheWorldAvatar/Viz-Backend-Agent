...
public class ShaclPropertyBindingTest {
    ...
    void testGetters(String name,
        ...
        ShaclPropertyBinding sample = new ShaclPropertyBinding(
                genMockSparqlBinding(
                        new SparqlBindingTestParameters(name, group, branch, SAMPLE_PREDICATE,
                                null, null, null, null, false, isArray, false, isOptional)));
    ...
    private static Stream<Arguments> provideParametersForTestWrite() {
        return Stream.of(
                ...
                Arguments.of(EXPECTED_SIMPLE_CLAZZ_FILE, PROPERTY_FIELD, null, null, null, "", false, true),
                // Test for simple ID
                Arguments.of(EXPECTED_SIMPLE_ID_FILE, "id", null, SAMPLE_PREDICATE, null, "", true, false),
                // Test for simple group field
                Arguments.of(EXPECTED_SIMPLE_GROUP_FILE, PROPERTY_FIELD, GROUP_FIELD, null, null, "", false, false),
                // Test for simple nested class
                Arguments.of(EXPECTED_SIMPLE_NESTED_CLASS_FILE, PROPERTY_FIELD, null, null, null, SAMPLE_CLASS, false,
                        false),
    ...
    void testWrite(String expectedFileOutput,
        ...
        ShaclPropertyBinding sample = new ShaclPropertyBinding(
                genMockSparqlBinding(
                        new SparqlBindingTestParameters(name, group, null, SAMPLE_PREDICATE,
                                labelPred, null, instanceClazz, nestedClazz, inverseMultipath, false, isClazz, false)));
    ...
    void testAppendPred() throws IOException {
        ShaclPropertyBinding sample = new ShaclPropertyBinding(genMockSparqlBinding(
                new SparqlBindingTestParameters(PROPERTY_FIELD, null, null, SAMPLE_PREDICATE, null, null, null, null,
                        false, false, false, false)));
        SparqlBinding sampleWithSecondPred = genMockSparqlBinding(
                new SparqlBindingTestParameters(PROPERTY_FIELD, null, null, SAMPLE_SECOND_PREDICATE, null, null, null,
     ...
     * @param nestedClass   The related parent class if the field is nested within a
     *                      node shape
    ...
    public static SparqlBinding genMockSparqlBinding(SparqlBindingTestParameters params) {
        ...
        SparqlBindingTest.addResponseField(jsonBinding, ShaclResource.MULTI_NAME_PATH_VAR, params.nameMultipath);
        if (params.inverseMultipath) {
            SparqlBindingTest.addResponseField(jsonBinding, ShaclResource.MULTIPATH_VAR + ShaclResource.PATH_PREFIX,
        ...
        SparqlBindingTest.addResponseField(jsonBinding, ShaclResource.IS_ARRAY_VAR, String.valueOf(params.isArray));
        SparqlBindingTest.addResponseField(jsonBinding, ShaclResource.IS_CLASS_VAR, String.valueOf(params.isClass));
