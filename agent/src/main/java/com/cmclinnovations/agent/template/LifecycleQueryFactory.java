...
public class LifecycleQueryFactory {
    ...
    private static final String INVOICED_QUERY_STATEMENT = "?invoice <https://purl.org/p2p-o/invoice#hasInvoiceReference>/<https://www.omg.org/spec/Commons/Documents/isAbout> ?event_id";
