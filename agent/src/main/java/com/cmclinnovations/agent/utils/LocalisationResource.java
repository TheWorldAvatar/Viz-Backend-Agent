...
public class LocalisationResource {
  ...
  public static final String SINGLE_SERVICE_KEY = "single";
  public static final String ALTERNATE_DAY_SERVICE_KEY = "alt";
  public static final String PERPETUAL_SERVICE_KEY = "perpetual";
  public static final String REGULAR_SERVICE_KEY = "regular";
  public static final String FIXED_DATE_SERVICE_KEY = "fixed";
  ...
  public static final String EVENT_STATUS_BILLABLE_EXEMPT_KEY = "billableExempted";
