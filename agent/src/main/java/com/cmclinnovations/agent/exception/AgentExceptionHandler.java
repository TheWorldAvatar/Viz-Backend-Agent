...
public class AgentExceptionHandler {
  ...
  public AgentExceptionHandler(LocalisationService localisationService) {
  ...
  public ResponseEntity<String> invalidResourceHandling(Exception exception, WebRequest request) {
    ...
    return new ResponseEntity<>(
        this.localisationService.getMessage(LocalisationResource.ERROR_CONTACT_KEY, exception.getMessage()),
  ...
  public ResponseEntity<String> globalExceptionHandling(Exception exception, WebRequest request) {
    ...
    return new ResponseEntity<>(
        this.localisationService.getMessage(LocalisationResource.ERROR_TIMESTAMP_KEY, currentTime.format(formatter),
