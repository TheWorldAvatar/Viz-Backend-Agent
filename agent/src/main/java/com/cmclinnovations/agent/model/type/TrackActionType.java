...
public enum TrackActionType {
  ...
  CANCELLATION_REVERTED("https://theworldavatar.io/kg/ontochangelog/CancellationRevertedActivity",
      "label.activity.revert.cancel"),
  ...
  ISSUE_REPORT_REVERTED("https://theworldavatar.io/kg/ontochangelog/IssueReportRevertedActivity",
      "label.activity.revert.report"),
