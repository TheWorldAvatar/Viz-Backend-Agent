...
public class FileService {
  ...
  public static final String CUSTOM_QUERY_DIR = RESOURCE_DIR + "query/";
  ...
  public static final String VERIFY_PRICING_QUERY_RESOURCE = QUERY_GET_BILLING_DIR + "verify_pricing.sparql";
  ...
  public static final String TERMINAL_EVENT_QUERY_RESOURCE = QUERY_GET_LIFECYCLE_DIR + "terminal_event.sparql";
  ...
  public static final String INFER_CONTRACT_BRANCH_QUERY_RESOURCE = SPRING_FILE_PATH_PREFIX + CUSTOM_QUERY_DIR
